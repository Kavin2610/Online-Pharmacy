...
def detail(request, pk):
    ...
    average_rating = Rating.calculate_average_rating(item)
    average_rating_starts = int(average_rating) * "⭐"
    reviews = Rating.objects.filter(product=item) 

    return render(request, 'item/detail.html', {
        'item': item,
        'related_items': related_items,
        'average_rating': int(average_rating),
        'average_rating_starts': average_rating_starts,
        'reviews': reviews,  
    })
...
def reviews_list(request, product_id):
    ...
    return render(request, 'item/detail.html', {'reviews':reviews})
